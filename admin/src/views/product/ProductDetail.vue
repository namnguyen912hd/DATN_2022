...
<div class="m-info-item">
              <div class="m-info-name">Khoảng cách giao hàng tối thiểu</div>
              <div class="m-info-content">
                <money
                  class="m-input m-input-price m-text-right"
                  v-model="product.DistanceLimit"
                  v-bind="money"
                ></money>
                <span style="font-size:14px; margin-left: 4px">km</span>
              </div>
            </div>
            ...
            <div class="m-info-item">
              ...
              <div class="m-info-content" style="height: auto">
                <div class="m-info-color">
                  <span style="margin-left: 10px; height: auto">Kích cỡ</span>
                </div>
