  ...
  methods: {
    ...
    getAllProducts() {
      try {
        ...
        if (permission && permission.includes('product_view')) {
          // clean data
          let sort = "";
          let filters = "";
    ...
    onClickBtnClone() {
      try {
        let permission = localStorage.getItem('permission');
        if (permission && permission.includes('product_add')) {
          let me = this;
          let tempCode;
          let tempBarCode;
    ...
    onClickBtnUpdate() {
      try {
        let permission = localStorage.getItem('permission');
        if (permission && permission.includes('product_edit')) {
    ...
    onClickBtnDelete() {
      try {
        let permission = localStorage.getItem('permission');
        if (permission && permission.includes('product_delete')) {
          let title = "";
