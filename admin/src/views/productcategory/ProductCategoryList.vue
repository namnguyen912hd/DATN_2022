    ...
    <div class="m-content" v-show="isShowDetail == false">
      ...
      <div class="m-content-grid">
        ...
        <table class="m-table">
          ...
          <tbody>
            <tr v-for="cal in productCategoryList" :key="cal.ProductCategoryId">
              <td>
                <label class="m-checkbox-input">
              ...
              <td>{{ cal.ProductCategoryCode }}</td>
              <td>
                <span class="m-tr-action">{{ cal.ProductCategoryName }}</span>
              </td>
      ...
      <div class="m-content-pagination">
        <div class="m-pagination-left">
          ...
          <div class="m-icon m-icon-24 m-icon-refresh-24" @click="getAllproductCategory()"></div>
  ...
  methods: {
    ...
    getAllproductCategory() {
      try {
        ...
        if (permission && permission.includes('productcategory_view')) {
          // hiện loading
          me.isLoading = true;
          // Call api
          setTimeout(function () {
            BaseRequest.get(`${me.apiRouter}/`)
              .then((response) => {
                ...
                me.productCategoryList = response.data;
